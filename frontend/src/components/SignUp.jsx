...
const SignUp = () => {
    ...
    return (
        <div className='min-h-screen flex flex-col justify-between'>
            <div className='mt-[10rem] h-[35rem] w-[30rem] justify-center items-center lg:flex lg:flex-row lg:w-[60rem] xl:w-[70rem] 2xl:w-[80rem] m-auto border border-white lg:border-black rounded-[1rem] lg:justify-evenly shadow-2xl md:w-[40rem] sm:w-[30rem]'>
                ...
                <div className='w-[30rem] md:w-[40rem] sm:w-[30rem] flex flex-col justify-center items-center'>
                    ...
                    <form onSubmit={signUpSubmit}>
                        ...
                        <button className="submit border rounded-[4rem] w-[15rem] h-[3rem] p-1 mt-[2rem] bg-green-900 hover:bg-green-950 text-gray-100 text-lg">Sign Up</button>
                    </form>
